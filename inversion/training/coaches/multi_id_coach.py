...
class MultiIDCoach(BaseCoach):
    ...
    def __init__(self, data_loader, paths_config, use_wandb):
        super().__init__(data_loader, paths_config, use_wandb)
    ...
    def train(self):
        ...
        for fname, image in self.data_loader:
            ...
            if hyperparameters.first_inv_type == 'w+':
                embedding_dir = f'{w_path_dir}/{self.paths_config.e4e_results_keyword}/{image_name}'
            else:
        ...
        torch.save(self.G,
                   f'{self.paths_config.checkpoints_dir}/model_{global_config.run_name}_multi_id.pt')
